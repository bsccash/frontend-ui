      ...
      return (
        <StyledNoticeWrapper>
          <Notice color="green">
            ...
            <b>to continue earning BCS seigniorage.</b>
          </Notice>
        </StyledNoticeWrapper>
      );
    }
      ...
      <Switch>
        <Page>
          <PageHeader
            ...
            subtitle="Deposit Bsc Shares and earn inflationary rewards"
          />
          <LaunchCountdown
            deadline={config.boardroomLaunchesAt}
            description="How does the boardroom work?"
            descriptionLink="https://docs.bsc.cash/mechanisms/stabilization-mechanism#expansionary-policy"
          />
        </Page>
      </Switch>
    );
